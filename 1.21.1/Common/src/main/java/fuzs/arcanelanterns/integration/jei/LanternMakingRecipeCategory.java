...
public class LanternMakingRecipeCategory implements IRecipeCategory<LanternMakingRecipe> {
    ...
    public static final Component LANTERN_MAKING_COMPONENT = Component.translatable(Util.makeDescriptionId("recipe_type",
            ModRegistry.LANTERN_MAKING_RECIPE_TYPE.key().location()
    ));
