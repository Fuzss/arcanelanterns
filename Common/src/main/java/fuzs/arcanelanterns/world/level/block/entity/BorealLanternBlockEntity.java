...
public class BorealLanternBlockEntity extends LanternBlockEntity {
    ...
    public static void tick(Level level, BlockPos pos, BlockState state, BorealLanternBlockEntity blockEntity) {
        ...
        level.getEntitiesOfClass(LivingEntity.class, new AABB(pos.getX() + 0.5 - horizontalRange, pos.getY() + 0.5 - verticalRange, pos.getZ() + 0.5 - horizontalRange, pos.getX() + 0.5 + horizontalRange, pos.getY() + 0.5 + verticalRange, pos.getZ() + 0.5 + horizontalRange)).forEach((entity) -> {
